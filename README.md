...
**Les royaumes restent sur la carte après déconnexion et restent attaquables.** La sauvegarde n'est plus une téléportation. La production normale s'arrête à la fin d'une grâce de trois minutes ; les PA continuent de se régénérer jusqu'au plafond de vingt, à raison d’un toutes les trente secondes. Le premier départ reçoit 40 PA ; le surplus au-dessus de 20 ne régénère pas. Sur un serveur existant, régler aussi `AP_INTERVAL_MS=30000` dans `.env`, puis redémarrer l’application. Les nouvelles bannières bénéficient de dix minutes de protection, retirée par un acte hostile volontaire.
