...
- Les unités et bâtiments endommagés affichent une petite barre de vie sur la carte. Le catalogue propose **44 unités et 47 types de bâtiments**, dont deux évolutions de remparts, avec leurs rôles et prérequis dans les panneaux. Le campement évolue en avant-poste, puis en village. Une enceinte fermée revendique les terres neutres intérieures ; un bâtisseur proche permet d’y construire. Une brèche rend les cases sans bâtiment neutres (voir [remparts](docs/remparts.md)). Une filière aérienne ajoute reconnaissance, chasseurs, bombardiers, dirigeables et dragons occultes, avec canons antiaériens et quatre bâtiments dédiés (voir [règles aériennes](docs/aviation.md)).
...
**Les royaumes restent sur la carte après déconnexion et restent attaquables.** La sauvegarde n'est plus une téléportation. La production normale s'arrête à la fin d'une grâce de trois minutes ; les PA continuent de se régénérer jusqu'au plafond de vingt, à raison d’un toutes les dix secondes. Le premier départ reçoit 40 PA, 500 or, 500 bois, 500 pierre et 500 fer (0 vivres) ; le surplus au-dessus de 20 ne régénère pas. Sur un serveur existant, régler aussi `AP_INTERVAL_MS=10000` dans `.env`, puis redémarrer l’application. Les nouvelles bannières bénéficient de dix minutes de protection, retirée par un acte hostile volontaire.
