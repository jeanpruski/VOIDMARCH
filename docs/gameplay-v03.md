...
- Nouveau royaume humain : 40 PA au premier départ. Le surplus au-dessus de 20 reste disponible sans régénérer ; après sa consommation, récupération de 1 PA toutes les 10 secondes jusqu’à 20. Les royaumes existants et les bots ne reçoivent pas un nouveau bonus.
...
- Code caché validé par l’utilisateur pour tous ceux qui le connaissent : sur la carte, hors champ texte et fenêtre, taper `aqw` puis Entrée. Répéter pour désactiver. Les codes PA illimités et radar reviennent à OFF au lancement ou au rechargement de la page, sans changer le stock de PA. Le serveur vérifie le code ; la session doit être authentifiée. PA, carburant et pervitine illimités affichés par ∞ ; les réserves normales sont conservées. Les matériaux, la population, les portées, les terrains, les trêves et les autres règles restent exigés.
...
Recrutement : disponibles immédiatement, puis autres unités avec priorité aux coûts abordables ; à égalité civils et soutien, combattants par force croissante, véhicules en dernier. Les statistiques effectives après entraînement, le bonus et le palier technologique sont explicités.
