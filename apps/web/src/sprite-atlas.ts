...
export const SPRITE_ATLASES: Record<string, { columns: number; rows: number }> = {
  ...
  terraformer: { columns: 1, rows: 1 },
  'rad-infantry': { columns: 3, rows: 2 },
  'rad-cavalry': { columns: 3, rows: 2 },
  'rad-motorcycles': { columns: 3, rows: 2 },
  'rad-vehicles': { columns: 3, rows: 2 },
  'rad-planes': { columns: 3, rows: 2 },
  'rad-helicopters': { columns: 3, rows: 2 },
  'rad-buildings': { columns: 2, rows: 2 },
